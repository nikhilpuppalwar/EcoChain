    ...
    return (
        <div className="bg-[#f3f4f6] dark:bg-[#221610] font-['DM_Sans',sans-serif] text-slate-900 dark:text-slate-100 min-h-screen flex flex-col justify-center items-center py-12 px-4">
            <div className="w-full max-w-3xl flex flex-col gap-8">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-[0_20px_40px_-10px_rgba(0,0,0,0.05),_0_0_20px_-10px_rgba(26,122,74,0.1)] dark:shadow-none border border-slate-200 dark:border-slate-800 overflow-hidden w-full">
                    <div className="flex border-b border-slate-100 dark:border-slate-800">
                        <div className="flex-1 py-5 text-center border-b-2 border-[#1A7A4A] bg-[#1A7A4A]/5 relative">
                            <span className="text-xs font-bold font-['Syne',sans-serif] text-[#1A7A4A] flex items-center justify-center gap-2 tracking-wide">
                    ...
                    <div className="p-8 md:p-10">
                        <div className="mb-10 text-center">
                            <span className="inline-flex items-center px-3 py-1 rounded-full bg-[#1A7A4A]/10 text-[#1A7A4A] text-[10px] font-bold uppercase tracking-wider mb-4 border border-[#1A7A4A]/20">
                                Step 1 of 3
                            </span>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 max-w-2xl mx-auto">
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    <select {...register('ministry')} className="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-xl text-sm py-4 px-5 focus:ring-2 focus:ring-[#1A7A4A] focus:border-[#1A7A4A] transition-all appearance-none text-slate-700 dark:text-slate-200 font-medium cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700/50">
                                    ...
                                    <span className="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 group-hover:text-[#1A7A4A] transition-colors pointer-events-none">expand_more</span>
                                </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <label className={`relative flex items-center p-4 rounded-xl border-2 cursor-pointer transition-all ${selectedDept === 'Carbon Markets Division' ? 'border-[#1A7A4A] bg-[#1A7A4A]/5 hover:shadow-md' : 'border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800 hover:border-[#1A7A4A]/40 hover:bg-white dark:hover:bg-slate-800 hover:shadow-sm group'}`}>
                                        <input {...register('department')} value="Carbon Markets Division" className="hidden peer" type="radio" />
                                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center mr-4 shadow-sm transition-colors ${selectedDept === 'Carbon Markets Division' ? 'bg-white dark:bg-slate-900 text-[#1A7A4A] border border-[#1A7A4A]/10' : 'bg-white dark:bg-slate-700 text-slate-400 group-hover:text-[#1A7A4A]'}`}>
                                        ...
                                        <div className={`absolute top-3 right-3 text-[#1A7A4A] transition-all ${selectedDept === 'Carbon Markets Division' ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
                                            <span className="material-symbols-outlined text-xl">check_circle</span>
                                        </div>
                                    </label>
                                    <label className={`relative flex items-center p-4 rounded-xl border-2 cursor-pointer transition-all ${selectedDept === 'Compliance & Enforcement' ? 'border-[#1A7A4A] bg-[#1A7A4A]/5 hover:shadow-md' : 'border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800 hover:border-[#1A7A4A]/40 hover:bg-white dark:hover:bg-slate-800 hover:shadow-sm group'}`}>
                                        <input {...register('department')} value="Compliance & Enforcement" className="hidden peer" type="radio" />
                                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center mr-4 shadow-sm transition-colors ${selectedDept === 'Compliance & Enforcement' ? 'bg-white dark:bg-slate-900 text-[#1A7A4A] border border-[#1A7A4A]/10' : 'bg-white dark:bg-slate-700 text-slate-400 group-hover:text-[#1A7A4A]'}`}>
                                        ...
                                        <div className={`absolute top-3 right-3 text-[#1A7A4A] transition-all ${selectedDept === 'Compliance & Enforcement' ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
                                            <span className="material-symbols-outlined text-xl">check_circle</span>
                                        </div>
                                    </label>
                                    <label className={`relative flex items-center p-4 rounded-xl border-2 cursor-pointer transition-all ${selectedDept === 'Emission Reporting Cell' ? 'border-[#1A7A4A] bg-[#1A7A4A]/5 hover:shadow-md' : 'border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800 hover:border-[#1A7A4A]/40 hover:bg-white dark:hover:bg-slate-800 hover:shadow-sm group'}`}>
                                        <input {...register('department')} value="Emission Reporting Cell" className="hidden peer" type="radio" />
                                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center mr-4 shadow-sm transition-colors ${selectedDept === 'Emission Reporting Cell' ? 'bg-white dark:bg-slate-900 text-[#1A7A4A] border border-[#1A7A4A]/10' : 'bg-white dark:bg-slate-700 text-slate-400 group-hover:text-[#1A7A4A]'}`}>
                                        ...
                                        <div className={`absolute top-3 right-3 text-[#1A7A4A] transition-all ${selectedDept === 'Emission Reporting Cell' ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
                                            <span className="material-symbols-outlined text-xl">check_circle</span>
                                        </div>
                                    </label>
                                    <label className={`relative flex items-center p-4 rounded-xl border-2 cursor-pointer transition-all ${selectedDept === 'PAT Scheme Bureau' ? 'border-[#1A7A4A] bg-[#1A7A4A]/5 hover:shadow-md' : 'border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800 hover:border-[#1A7A4A]/40 hover:bg-white dark:hover:bg-slate-800 hover:shadow-sm group'}`}>
                                        <input {...register('department')} value="PAT Scheme Bureau" className="hidden peer" type="radio" />
                                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center mr-4 shadow-sm transition-colors ${selectedDept === 'PAT Scheme Bureau' ? 'bg-white dark:bg-slate-900 text-[#1A7A4A] border border-[#1A7A4A]/10' : 'bg-white dark:bg-slate-700 text-slate-400 group-hover:text-[#1A7A4A]'}`}>
                                        ...
                                        <div className={`absolute top-3 right-3 text-[#1A7A4A] transition-all ${selectedDept === 'PAT Scheme Bureau' ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
                                            <span className="material-symbols-outlined text-xl">check_circle</span>
                                        </div>
                                    </label>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        <select {...register('jurisdiction')} className="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-xl text-sm py-3.5 px-4 focus:ring-2 focus:ring-[#1A7A4A] focus:border-[#1A7A4A] transition-all appearance-none text-slate-700 dark:text-slate-200">
                                        ...
                                        <span className="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 group-hover:text-[#1A7A4A] transition-colors pointer-events-none">map</span>
                                    </div>
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between">
                                        ...
                                        <div className="group/tooltip relative">
                                            <span className="material-symbols-outlined text-slate-400 text-sm cursor-help hover:text-[#1A7A4A] transition-colors">help</span>
                                    ...
                                    <div className="relative">
                                        <input {...register('authorizationCode')} className="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-xl text-sm py-3.5 px-4 pl-10 focus:ring-2 focus:ring-[#1A7A4A] focus:border-[#1A7A4A] transition-all font-mono tracking-wide placeholder-slate-400" placeholder="XXXX-XXXX-XXXX" type="text" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input {...register('officeAddress')} className="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-xl text-sm py-3.5 px-4 focus:ring-2 focus:ring-[#1A7A4A] focus:border-[#1A7A4A] transition-all placeholder-slate-400" placeholder="Floor, Building, Area" type="text" />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input {...register('websiteUrl')} className="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-xl text-sm py-3.5 px-4 focus:ring-2 focus:ring-[#1A7A4A] focus:border-[#1A7A4A] transition-all placeholder-slate-400" placeholder="https://gov.in/..." type="url" />
                                    {errors.websiteUrl && <p className="text-red-500 text-xs mt-1">{errors.websiteUrl.message}</p>}
                                </div>
                            </div>
                            <div className="flex gap-4 p-5 rounded-xl bg-[#1A7A4A]/5 border border-[#1A7A4A]/10 mt-6">
                                <div className="shrink-0 w-8 h-8 rounded-full bg-[#1A7A4A]/10 flex items-center justify-center text-[#1A7A4A]">
                            ...
                            <div className="pt-2">
                                <button type="submit" className="w-full py-4 px-6 bg-[#1A7A4A] hover:bg-[#2E9E68] text-white font-bold font-['Syne',sans-serif] rounded-xl shadow-lg shadow-[#1A7A4A]/20 hover:shadow-[#1A7A4A]/30 active:scale-[0.99] transition-all flex items-center justify-center gap-3 group text-base tracking-wide">
                ...
                <p className="text-center text-xs text-slate-400 font-medium">
                    Already registered? <Link className="text-[#1A7A4A] font-bold hover:underline transition-all" to="/login">Sign In to Dashboard</Link>
                </p>
            </div>
        </div>
    );

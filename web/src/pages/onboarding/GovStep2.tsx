...
export default function GovStep2() {
    ...
    const { register, handleSubmit, watch, formState: { errors } } = useForm<FormValues>({
        ...
        defaultValues: existingData ? {
            ...
            designation: existingData.designation as FormValues['designation'],
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
                        ...
                        <div className="md:col-span-2 flex flex-col gap-2 pt-4 border-t border-slate-200 dark:border-slate-800">
                            ...
                            <label htmlFor="idUpload" className={`relative border-2 border-dashed ${fileError ? 'border-red-500 bg-red-50' : 'border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50'} rounded-xl p-8 hover:bg-emerald-50 dark:hover:bg-emerald-900/10 hover:border-emerald-500 transition-all cursor-pointer flex flex-col items-center justify-center text-center group`}>
                                {idFile ? (
                                    <>
                                        ...
                                        <div className="px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-bold shadow-sm group-hover:shadow transition-shadow">
                                            Change File
                                        </div>
                                    </>
                                ) : (
